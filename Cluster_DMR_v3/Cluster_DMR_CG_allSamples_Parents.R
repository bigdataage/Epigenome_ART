...
## Example:  
## Rscript  Cluster_DMR_CG_allSamples_Parents.R     2_rmXY_CpG_5Reads     4A_Parents_rmXY_1kb          
...
Sex_NC_g = rep( x="father",  times=length(Files_NC_g) )  
for(i in c(1:length(Sex_NC_g)) ) {
  Sex_NC_g[i] = "father"
  if(i>=12) { Sex_NC_g[i] = "mother" }
}
...
Sex_IVF_fresh_g = rep( x="father",      times=length(Files_IVF_fresh_g) ) 
for(i in c(1:length(Sex_IVF_fresh_g)) ) {
  Sex_IVF_fresh_g[i] = "father"
  if(i>=17) { Sex_IVF_fresh_g[i] = "mother" }
}
...
Sex_IVF_frozen_g = rep( x="father",      times=length(Files_IVF_frozen_g) )
for(i in c(1:length(Sex_IVF_frozen_g)) ) {
  Sex_IVF_frozen_g[i] = "father"
  if(i>=18) { Sex_IVF_frozen_g[i] = "mother" }
}
...
Sex_ICSI_fresh_g = rep( x="father",      times=length(Files_ICSI_fresh_g) )  
for(i in c(1:length(Sex_ICSI_fresh_g)) ) {
  Sex_ICSI_fresh_g[i] = "father"
  if(i>=16) { Sex_ICSI_fresh_g[i] = "mother" }
}
...
Sex_ICSI_frozen_g = rep( x="father",      times=length(Files_ICSI_frozen_g) )  
for(i in c(1:length(Sex_ICSI_frozen_g)) ) {
  Sex_ICSI_frozen_g[i] = "father"
  if(i>=11) { Sex_ICSI_frozen_g[i] = "mother" }
}
