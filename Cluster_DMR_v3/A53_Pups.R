...
## Example:  
## Rscript  A53_Pups.R     2-SplitXY/A-rmXY     3A_A53Pups_rmXY_100bp   >     3A_A53Pups_rmXY_100bp.runLog  2>&1     
...
# inputDir_g =  "2-SplitXY/A-rmXY"
# outDir_g   =  "3A_A53Pups_rmXY_100bp"
print(inputDir_g)   
print(outDir_g)
...
Files_NC_g <- c(
  paste( inputDir_g,   "batch1_1_A53C-boy_Rep1.bismark.cov",      sep="/"),
  paste( inputDir_g,   "batch1_2_A53D-boy_Rep1.bismark.cov",      sep="/")
)
...
Files_IVF_fresh_g <- c(   
  paste( inputDir_g,     "chenwei_69_A53C-boy-NC_Rep9.CpG.bismark.cov",   sep="/"),
  paste( inputDir_g,     "chenwei_69_A53D-boy-NC_Rep9.CpG.bismark.cov",     sep="/")  
)
...
Files_IVF_frozen_g <- c(  
  paste( inputDir_g,     "PCOS_1000_M28-A53C_Rep1.CpG.bismark.cov",   sep="/"),
  paste( inputDir_g,     "PCOS_1000_M29-A53D_Rep1.CpG.bismark.cov",    sep="/")   
)
...
Files_ICSI_fresh_g <- c(
    paste( inputDir_g,    "batch1_3_A53F-father_Rep1.bismark.cov",    sep="/")     
)

mySampleID_ICSI_fresh_g <- rep( x="batch1F", times=length(Files_ICSI_fresh_g) )
...
Files_ICSI_frozen_g <- c(
    paste( inputDir_g,    "batch1_4_A53M-mother_Rep1.bismark.cov",       sep="/")  
)

mySampleID_ICSI_frozen_g <- rep( x="batch1M", times=length(Files_ICSI_frozen_g) )
...
Sex_ICSI_frozen_g = rep( x="mother",      times=length(Files_ICSI_frozen_g) )  
for(i in c(1:length(Sex_ICSI_frozen_g)) ) {
  Sex_ICSI_frozen_g[i] = "mother"
...
myTech_All_color_g = c( "batch1"="black", "batch2"="blue", "batch3"="green",  "batch1F"="red", "batch1M"="purple" )
mySex_All_shape_g
myTech_All_color_g
...
c( "batch1"="black", "batch2"="blue", "batch3"="green",  "batch1F"="red", "batch1M"="purple" )
...
MyTech_color_g <- function(  myTech_vector  ) {
  ...
  for(i in c(1:length(myTech_color)) ) {
    ...
    if(myTech_color[i] == "batch1F")  { myTech_color[i] = c("batch1F"="red")    }
    if(myTech_color[i] == "batch1M")  { myTech_color[i] = c("batch1M"="purple") }
  }
...
MyTech_number_g <- function(  myTech_vector  ) {
  ...
  for(i in c(1:length(myTech_color)) ) {
    ...
    if(myTech_color[i] == "batch1F")  { myTech_color[i] = 4 }
    if(myTech_color[i] == "batch1M")  { myTech_color[i] = 5 }
  }
  return(myTech_color)
}
...
##################################################################################################################
{
  ...
  ###
  myMainFunction1bp_2_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/Results_1bpBin/1-matrix-all",  sep="") ,
                          dataFrame_temp1 = dataFrame_temp100_A    )
  
  ###
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/Results_100bp_1Cs/1-matrix-all",  sep="") ,   
...
##################################################################################################################
{
  ...
  ###
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/1_allBatchs_100bp_2bases",  sep="") ,   
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2_NC-vs-IVFfresh_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp2_A  )
}
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/3_NC-vs-IVFfrozen_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp3_A  )
}
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/4_NC-vs-ICSIfresh_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp4_A  )
}
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/5_NC-vs-ICSIfrozen_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp5_A  )
}
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/6_IVF_fresh_vs_IVF_frozen_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp6_A  )
}   
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/7_IVF_fresh_vs_ICSI_fresh_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp7_A  )
}  
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/8_IVF_fresh_vs_ICSI_frozen_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp8_A  )
}
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/9_IVF_frozen_vs_ICSI_fresh_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp9_A  )
}
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/10_IVF_frozen_vs_ICSI_frozen_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp10_A  )
}
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/11_ICSI_fresh_vs_ICSI_frozen_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp11_A  )
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/12_NC_vs_IVF_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp12_A  )
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/13_NC_vs_ICSI_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp13_A  )
}  
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/14_NC_vs_fresh_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp14_A  )
}  
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/15_NC_vs_frozen_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp15_A  )
} 
##################################################################################################################
...
##################################################################################################################
{
  ...
  ###
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/16_NC_vs_ART_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp16_A  )
}
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/17_IVF_vs_ICSI_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp17_A  )
}  
##################################################################################################################
...
##################################################################################################################
{
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/18_fresh_vs_frozen_100bp_2bases",  sep="") ,   
                       binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp18_A  )
}
##################################################################################################################
