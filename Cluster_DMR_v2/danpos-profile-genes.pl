...
say  "\n
        ...
        ##########################################################
\n";
## Example:  perl  danpos-profile-genes.pl  -in  1-H3K4me1.bed
###################################################################################################################################################################################################
...
while (my $file1=readdir DIRHANDLE) {       
    ...
    system("danpos.py  profile $file2  --genefile_paths  $region    --heatmap 1   --name $outprefix  --bin_size 20   --flank_up 10000  --flank_dn 10000  --region_size 5000   --plot_row 1  --plot_column 1  --plot_colors green ");                                       
}
