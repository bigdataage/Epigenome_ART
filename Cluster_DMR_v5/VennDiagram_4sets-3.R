...
myA = 2218   # PupsSex_hyper
myB = 931    # PupsSex_hypo
myC = 1567   # Children_hyper
myD = 1566   # Children_hypo
...
venn.diagram(x=list("PupsSex_hyper"=x1,   "PupsSex_hypo"=x2,  "Children_hyper"=x3,  "Children_hypo"=x4), 
             filename=myFile, 
             height = 3,   width = 4.5,  
