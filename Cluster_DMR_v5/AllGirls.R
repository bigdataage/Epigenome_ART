...
## Example:  
##          Rscript  AllGirls.R     1-covFiles/All     300-AllGirls/All   >     300-AllGirls_All.runLog  2>&1     
...
#   inputDir_g =  "1-covFiles/All"
#   outDir_g   =  "300-AllGirls/All"
print(inputDir_g)   
print(outDir_g)
...
if( length(Files_NC_g) >= 1) {
    ...
    Sex_NC_g = rep( x="girl",  times=length(Files_NC_g) )  
...
if( length(Files_IVF_fresh_g) >= 1) {
    ...
    Sex_IVF_fresh_g = rep( x="girl",      times=length(Files_IVF_fresh_g) ) 
    for(i in c(1:length(Sex_IVF_fresh_g)) ) {
        Sex_IVF_fresh_g[i] = "girl"
...
if( length(Files_IVF_frozen_g) >= 1) {
    ...
    Sex_IVF_frozen_g = rep( x="girl",      times=length(Files_IVF_frozen_g) )
    for(i in c(1:length(Sex_IVF_frozen_g)) ) {
      Sex_IVF_frozen_g[i] = "girl"
...
if( length(Files_ICSI_fresh_g) >= 1) {
    ...
    Sex_ICSI_fresh_g = rep( x="girl",      times=length(Files_ICSI_fresh_g) )  
    for(i in c(1:length(Sex_ICSI_fresh_g)) ) {
      Sex_ICSI_fresh_g[i] = "girl"
...
if( length(Files_ICSI_frozen_g) >= 1) {
    ...
    Sex_ICSI_frozen_g = rep( x="girl",      times=length(Files_ICSI_frozen_g) )  
    for(i in c(1:length(Sex_ICSI_frozen_g)) ) {
      Sex_ICSI_frozen_g[i] = "girl"
...
myTech_All_color_g = c( "NC"="black",   "IVF_fresh"="cyan3", "IVF_frozen"="blue3",  "ICSI_fresh"="purple3", "ICSI_frozen"="red3" )
...
MyTech_color_g <- function(  myTech_vector  ) {
  ...
  for(i in c(1:length(myTech_color)) ) {
    ...
    if(myTech_color[i] == "IVF_fresh")   { myTech_color[i] = c("IVF_fresh"="cyan3") }
    if(myTech_color[i] == "IVF_frozen")  { myTech_color[i] = c("IVF_frozen"="blue3") }
    if(myTech_color[i] == "ICSI_fresh")  { myTech_color[i] = c("ICSI_fresh"="purple3") }
    if(myTech_color[i] == "ICSI_frozen") { myTech_color[i] = c("ICSI_frozen"="red3") }
  }
...
myHierarchicalClustering_1A_g  <- function(  mat_3three,   path_temp1,  width1, height1   )  {
  class_3three <- colnames(mat_3three)
  class_3three <- gsub(pattern="_\\d+$", replacement="", x=class_3three, ignore.case = FALSE, perl = TRUE )
  MyTech_color_g( class_3three )
...
myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/11_ICSI_fresh_vs_ICSI_frozen_100bpBin",  sep="") ,   
                     binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp11_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/11_ICSI_fresh_vs_ICSI_frozen_speRegions",  sep="") ,  
...
myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/6_IVF_fresh_vs_IVF_frozen_100bpBin",  sep="") ,   
                     binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp6_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/6_IVF_fresh_vs_IVF_frozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/18_fresh_vs_frozen_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp18_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/18_fresh_vs_frozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/1A_allSamples_10bpBin_1Cs",  sep="") ,   
                          binSize_temp1 = 10,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp1_A  )
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/1_NC-vs-ART_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/1_NC-vs-ART_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/2_NC-vs-IVFfresh_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp2_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/2_NC-vs-IVFfresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/17_IVF_vs_ICSI_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp17_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/17_IVF_vs_ICSI_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/3_NC-vs-IVFfrozen_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp3_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/3_NC-vs-IVFfrozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/4_NC-vs-ICSIfresh_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp4_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/4_NC-vs-ICSIfresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/5_NC-vs-ICSIfrozen_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp5_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/5_NC-vs-ICSIfrozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/7_IVF_fresh_vs_ICSI_fresh_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp7_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/7_IVF_fresh_vs_ICSI_fresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/8_IVF_fresh_vs_ICSI_frozen_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp8_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/8_IVF_fresh_vs_ICSI_frozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/9_IVF_frozen_vs_ICSI_fresh_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp9_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/9_IVF_frozen_vs_ICSI_fresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/10_IVF_frozen_vs_ICSI_frozen_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp10_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/10_IVF_frozen_vs_ICSI_frozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/12_NC_vs_IVF_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp12_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/12_NC_vs_IVF_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/13_NC_vs_ICSI_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp13_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/13_NC_vs_ICSI_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/14_NC_vs_fresh_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp14_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/14_NC_vs_fresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,     path_temp1 = paste(outDir_g, "/15_NC_vs_frozen_100bpBin",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g,   dataFrame_temp1 = dataFrame_temp15_A  )
  
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2=paste(outDir_g, "/15_NC_vs_frozen_speRegions",  sep="") ,  
