...
###########################################################################################################################################################################
rawMatrix_1 <- read.table("diff1_number.txt", header=FALSE,   sep="\t" )  
dim(rawMatrix_1 )
rawMatrix_1[1:3,]
...
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=AllResults_g , fileName1="diff1-1-a",  height1=4,  width1=6)
...
FigureTemp1 <- ggplot(DataFrame_Local1, aes(x=xAxis  , fill=SampleType2, y=yAxis ) )  +
  ...
  xlab("Samples") + ylab("Number of DMCs") +  MyTheme_1(textSize=12 )   
MySaveGgplot2_1(ggplot2Figure1=FigureTemp1,  path1=AllResults_g , fileName1="diff1-1-b",  height1=4,  width1=6)
