...
## Example:  
##          Rscript  AllBoys.R     1-covFiles/All     200-AllBoys/All   >     200-AllBoys_All.runLog  2>&1     
...
Files_NC_g <- c(
  ...
  paste( inputDir_g,   "chenwei2_253_A91C-boy-NC_Rep1.bismark.cov",  sep="/" )
)
...
if( length(Files_IVF_frozen_g) >= 1) {
    ...
    for(i in c(1:length(Sex_IVF_frozen_g)) ) {
      ...
      if(i>=13) { Sex_IVF_frozen_g[i] = "boy" }
    }
}
...
if( length(Files_ICSI_fresh_g) >= 1) {
    ...
    for(i in c(1:length(Sex_ICSI_fresh_g)) ) {
      ...
      if(i>=13) { Sex_ICSI_fresh_g[i] = "boy" }
    }
}
...
Files_ICSI_frozen_g <- c(
  ...
  paste( inputDir_g,    "chenwei2_92_A62D-boy-ICSI-frozen_Rep1.bismark.cov",  sep="/" )
)
...
if( length(Files_ICSI_frozen_g) >= 1) {
    ...
    for(i in c(1:length(Sex_ICSI_frozen_g)) ) {
      ...
      if(i>=13) { Sex_ICSI_frozen_g[i] = "boy" }
    }
}
