...
## Example:  
## Rscript  plot_DMR_number.R     ICSI-number.txt       
...
MyHistogram_1 <- function(x1, y1,  mytype1, mytype2,   path2,   fileName2,  title2,  xLab2,  height2=4,  width2=4 ) {
  ...
  FigureTemp1 <- ggplot( data=dataframeB,  aes(x=xAxis, y=yAxis, fill=Type1 ) )  +  facet_wrap(~Type2, scales = "free_x") +
...
MyLines_1 <- function(x1, y1,  mytype1, mytype2,   path2,   fileName2,  title2,  xLab2,  height2=4,  width2=4 ) {
  if( ! file.exists(path2)   ) { dir.create(path2, recursive = TRUE) }
  dataframeB  <- data.frame(list( xAxis = x1,  yAxis =y1,  Type1=mytype1, Type2=mytype2  )  ) 
...
MyHistogram_1(x1 = rawMatrix_1$Comparisons, y1 = rawMatrix_1$Number,  
              mytype1 = rawMatrix_1$DMRs, mytype2 = rawMatrix_1$Analysis,  
              path2 = paste(outDir_g, input_g, sep="/"),   fileName2 = "Histogram",  title2 = input_g,  
              xLab2 = "Comparisons",  height2=6,  width2=12 )



MyLines_1(x1 = rawMatrix_1$Comparisons, y1 = rawMatrix_1$Number,  
              mytype1 = rawMatrix_1$DMRs, mytype2 = rawMatrix_1$Analysis,  
              path2 = paste(outDir_g, input_g, sep="/"),   fileName2 = "Lines",  title2 = input_g,  
              xLab2 = "Comparisons",  height2=6,  width2=12 )
...
MyLines_3 <- function(x1, y1,  mytype1, mytype2,   path2,   fileName2,  title2,  xLab2,  height2=4,  width2=4 ) {
  if( ! file.exists(path2)   ) { dir.create(path2, recursive = TRUE) }
  dataframeB  <- data.frame(list( xAxis = x1,  yAxis =y1,  Type1=mytype1, Type2=mytype2  )  ) 
...
MyLines_3(x1 = as.character( rawMatrix_2$Comparisons ), y1 = rawMatrix_2$Number,  
          mytype1 = rawMatrix_2$DMRs, mytype2 = rawMatrix_2$Analysis,  
          path2 = paste(outDir_g, input_g, sep="/"),   fileName2 = "Lines2",  title2 = input_g,  
          xLab2 = "Comparisons",  height2=6,  width2=8 )
