...
for ( my $i=1; $i<=$#lines; $i++ ) {
        ...
        if($i==6)  {print   OUTPUT_FH   "myBC = $number \n";}  #
        if($i==7)  {print   OUTPUT_FH   "myBCD = $number \n";}
        if($i==8)  {print   OUTPUT_FH   "myA = $number \n";}
        if($i==9)  {print   OUTPUT_FH   "myAD = $number \n";} #
        if($i==10)  {print   OUTPUT_FH   "myAC = $number \n";}
        if($i==11)  {print   OUTPUT_FH   "myACD = $number \n";}
        if($i==12) {print   OUTPUT_FH   "myAB = $number \n";}
        if($i==13) {print   OUTPUT_FH   "myABD = $number \n";}
        if($i==14) {print   OUTPUT_FH   "myABC = $number \n";}
        if($i==15) {print   OUTPUT_FH   "myABCD = $number \n";}
}
...
x1 <- c(x_A, myAC, myACD, myAB,  myABD, myABC, myABCD, myAD   )
x2 <- c(x_B, myBD, myBCD, myAB,  myABD, myABC, myABCD, myBC  )
x3 <- c(x_C, myCD, myBCD, myAC,  myACD, myABC, myABCD, myBC  )
x4 <- c(x_D, myCD, myBD,  myBCD, myACD, myABD, myABCD, myAD   ) 
