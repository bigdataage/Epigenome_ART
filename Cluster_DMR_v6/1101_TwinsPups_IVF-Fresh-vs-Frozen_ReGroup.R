...
## Example:  
## Rscript  1101_TwinsPups_IVF-Fresh-vs-Frozen_ReGroup.R     12_Twins/A-rmXY     1101_TwinsPups_IVF-Fresh-vs-Frozen_ReGroup/A-rmXY    >     1101_TwinsPups_IVF-Fresh-vs-Frozen_ReGroup_A-rmXY.runLog  2>&1     
...
#   outDir_g   =  "1101_TwinsPups_IVF-Fresh-vs-Frozen_ReGroup_test/C-onlyX"
...
# Label of each group:
Label_one_1_g   = "IVF-fresh1"
Label_two_2_g   = "IVF-fresh2"
Label_three_3_g = "IVF-frozen1"
Label_four_4_g  = "IVF-frozen2"
Label_five_5_g  =  c()


Files_one_1_g1   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/IVF-fresh_1", sep="") ,      pattern = "" ,    full.names = TRUE )
Files_two_2_g1   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/IVF-fresh_2", sep="") ,      pattern = "" ,    full.names = TRUE )
Files_three_3_g1 = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_1", sep="") ,    pattern = "" ,    full.names = TRUE )
Files_four_4_g1  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_2", sep="") ,    pattern = "" ,    full.names = TRUE )
# Files_five_5_g1  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_2", sep="") ,    pattern = "" ,    full.names = TRUE )

ShortName_one_1_g1   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/IVF-fresh_1", sep="") ,      pattern = "" ,    full.names = FALSE )
ShortName_two_2_g1   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/IVF-fresh_2", sep="") ,      pattern = "" ,    full.names = FALSE )
ShortName_three_3_g1 = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_1", sep="") ,    pattern = "" ,    full.names = FALSE )
ShortName_four_4_g1  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_2", sep="") ,    pattern = "" ,    full.names = FALSE )
# Files_five_5_g1  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_2", sep="") ,    pattern = "" ,    full.names = FALSE )
...
Files_one_1_g   = c( Files_one_1_g1[-myRandomIndex1A], Files_two_2_g1[myRandomIndex1A] )
Files_two_2_g   = c( Files_one_1_g1[myRandomIndex1A],  Files_two_2_g1[-myRandomIndex1A] )
Files_three_3_g = c( Files_three_3_g1[-myRandomIndex2A], Files_four_4_g1[myRandomIndex2A] )
Files_four_4_g  = c( Files_three_3_g1[myRandomIndex2A], Files_four_4_g1[-myRandomIndex2A] )

ShortName_one_1_g   = c( ShortName_one_1_g1[-myRandomIndex1A], ShortName_two_2_g1[myRandomIndex1A] )
ShortName_two_2_g   = c( ShortName_one_1_g1[myRandomIndex1A],  ShortName_two_2_g1[-myRandomIndex1A] )
ShortName_three_3_g = c( ShortName_three_3_g1[-myRandomIndex2A], ShortName_four_4_g1[myRandomIndex2A] )
ShortName_four_4_g  = c( ShortName_three_3_g1[myRandomIndex2A], ShortName_four_4_g1[-myRandomIndex2A] )
