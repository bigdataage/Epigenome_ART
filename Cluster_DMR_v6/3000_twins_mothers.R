...
## Example:  
## Rscript  3000_twins_mothers.R     12_Twins/A-rmXY     3000_twins_mothers/A-rmXY    >     3000_twins_mothers_A-rmXY.runLog  2>&1     
...
#   outDir_g   =  "3000_twins_mothers_test/C-onlyX"
...
# Label of each group:
Label_one_1_g   = "NC"
Label_two_2_g   = "IVF-fresh"
Label_three_3_g = "ICSI-fresh"
Label_four_4_g  = "IVF-frozen"
Label_five_5_g  = "ICSI-frozen"

Files_one_1_g   = list.files( path = paste(inputDir_g, "/", "Parents_NC/ALL", sep="") ,                pattern = "-mother-" ,    full.names = TRUE )
Files_two_2_g   = list.files( path = paste(inputDir_g, "/", "Parents_Fresh/IVF-fresh", sep="") ,       pattern = "-mother-" ,    full.names = TRUE )
Files_three_3_g = list.files( path = paste(inputDir_g, "/", "Parents_Fresh/ICSI-fresh", sep="") ,      pattern = "-mother-" ,    full.names = TRUE )
Files_four_4_g  = list.files( path = paste(inputDir_g, "/", "Parents_Frozen/IVF-frozen", sep="") ,     pattern = "-mother-" ,    full.names = TRUE )
Files_five_5_g  = list.files( path = paste(inputDir_g, "/", "Parents_Frozen/ICSI-frozen", sep="") ,    pattern = "-mother-" ,    full.names = TRUE )

ShortName_one_1_g   = list.files( path = paste(inputDir_g, "/", "Parents_NC/ALL", sep="") ,               pattern = "-mother-" ,    full.names = FALSE )
ShortName_two_2_g   = list.files( path = paste(inputDir_g, "/", "Parents_Fresh/IVF-fresh", sep="") ,      pattern = "-mother-" ,    full.names = FALSE )
ShortName_three_3_g = list.files( path = paste(inputDir_g, "/", "Parents_Fresh/ICSI-fresh", sep="") ,     pattern = "-mother-" ,    full.names = FALSE )
ShortName_four_4_g  = list.files( path = paste(inputDir_g, "/", "Parents_Frozen/IVF-frozen", sep="") ,    pattern = "-mother-" ,    full.names = FALSE )
ShortName_five_5_g  = list.files( path = paste(inputDir_g, "/", "Parents_Frozen/ICSI-frozen", sep="") ,   pattern = "-mother-" ,    full.names = FALSE )
