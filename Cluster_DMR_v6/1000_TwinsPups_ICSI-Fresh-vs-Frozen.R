...
## Example:  
## Rscript  1000_TwinsPups_ICSI-Fresh-vs-Frozen.R     12_Twins/A-rmXY     1000_TwinsPups_ICSI-Fresh-vs-Frozen/A-rmXY    >     1000_TwinsPups_ICSI-Fresh-vs-Frozen_A-rmXY.runLog  2>&1     
...
#   outDir_g   =  "1000_TwinsPups_ICSI-Fresh-vs-Frozen_test/C-onlyX"
...
# Label of each group:
Label_one_1_g   = "ICSI-fresh1"
Label_two_2_g   = "ICSI-fresh2"
Label_three_3_g = "ICSI-frozen1"
Label_four_4_g  = "ICSI-frozen2"
Label_five_5_g  =  c()

Files_one_1_g   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/ICSI-fresh_1", sep="") ,      pattern = "" ,    full.names = TRUE )
Files_two_2_g   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/ICSI-fresh_2", sep="") ,      pattern = "" ,    full.names = TRUE )
Files_three_3_g = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/ICSI-frozen_1", sep="") ,    pattern = "" ,    full.names = TRUE )
Files_four_4_g  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/ICSI-frozen_2", sep="") ,    pattern = "" ,    full.names = TRUE )
# Files_five_5_g  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/ICSI-frozen_2", sep="") ,    pattern = "" ,    full.names = TRUE )

ShortName_one_1_g   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/ICSI-fresh_1", sep="") ,      pattern = "" ,    full.names = FALSE )
ShortName_two_2_g   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/ICSI-fresh_2", sep="") ,      pattern = "" ,    full.names = FALSE )
ShortName_three_3_g = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/ICSI-frozen_1", sep="") ,    pattern = "" ,    full.names = FALSE )
ShortName_four_4_g  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/ICSI-frozen_2", sep="") ,    pattern = "" ,    full.names = FALSE )
# Files_five_5_g  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/ICSI-frozen_2", sep="") ,    pattern = "" ,    full.names = FALSE )
