...
## Example:  
## Rscript  1302_singletons_pups_random2.R     13_Singletons/A-rmXY     1302_singletons_pups_random2/A-rmXY    >     1302_singletons_pups_random2_A-rmXY.runLog  2>&1     
...
#   inputDir_g =  "13_Singletons/C-onlyX"
#   outDir_g   =  "1302_singletons_pups_random2_test/C-onlyX"
...
CovSamples_g = 3        ## The number of covered samples of each group for kept CpG sites.
...
# Label of each group:
Label_one_1_g   = "random1"
Label_two_2_g   = "random2"
Label_three_3_g = "random3"
Label_four_4_g  = "random4"
Label_five_5_g  = "random5"

Files_one_1_g   = list.files( path = inputDir_g ,    pattern = "(-girl-NC_)|(-boy-NC_)" ,                    full.names = TRUE )
Files_two_2_g   = list.files( path = inputDir_g ,    pattern = "(-girl-IVF-fresh_)|(-boy-IVF-fresh_)" ,      full.names = TRUE )
Files_three_3_g = list.files( path = inputDir_g ,    pattern = "(-girl-ICSI-fresh_)|(-boy-ICSI-fresh_)" ,    full.names = TRUE )
Files_four_4_g  = list.files( path = inputDir_g ,    pattern = "(-girl-IVF-frozen_)|(-boy-IVF-frozen_)" ,    full.names = TRUE )
Files_five_5_g  = list.files( path = inputDir_g ,    pattern = "(-girl-ICSI-frozen_)|(-boy-ICSI-frozen_)" ,  full.names = TRUE )

ShortName_one_1_g   = list.files( path = inputDir_g ,    pattern = "(-girl-NC_)|(-boy-NC_)" ,                    full.names = FALSE )
ShortName_two_2_g   = list.files( path = inputDir_g ,    pattern = "(-girl-IVF-fresh_)|(-boy-IVF-fresh_)" ,      full.names = FALSE )
ShortName_three_3_g = list.files( path = inputDir_g ,    pattern = "(-girl-ICSI-fresh_)|(-boy-ICSI-fresh_)" ,    full.names = FALSE )
ShortName_four_4_g  = list.files( path = inputDir_g ,    pattern = "(-girl-IVF-frozen_)|(-boy-IVF-frozen_)" ,    full.names = FALSE )
ShortName_five_5_g  = list.files( path = inputDir_g ,    pattern = "(-girl-ICSI-frozen_)|(-boy-ICSI-frozen_)" ,  full.names = FALSE )





Files_merge_g = c(Files_one_1_g, Files_two_2_g, Files_three_3_g, Files_four_4_g, Files_five_5_g)
ShortName_merge_g = c(ShortName_one_1_g, ShortName_two_2_g, ShortName_three_3_g, ShortName_four_4_g, ShortName_five_5_g)

Index_merge_g = c(1:length(Files_merge_g))
myNumFiles1 = ceiling( length(Index_merge_g)/5)   ## floor or ceiling

myRandomIndex1 = sample( x=Index_merge_g, size=myNumFiles1 )
myRandomIndex2 = sample( x=Index_merge_g[-myRandomIndex1], size=myNumFiles1 )
myRandomIndex3 = sample( x=Index_merge_g[-c(myRandomIndex1, myRandomIndex2)], size=myNumFiles1 )
myRandomIndex4 = sample( x=Index_merge_g[-c(myRandomIndex1, myRandomIndex2, myRandomIndex3)], size=myNumFiles1 )
myRandomIndex5 = Index_merge_g[-c(myRandomIndex1, myRandomIndex2, myRandomIndex3,myRandomIndex4)] 



Files_one_1_g   = Files_merge_g[myRandomIndex1]
Files_two_2_g   = Files_merge_g[myRandomIndex2]   
Files_three_3_g = Files_merge_g[myRandomIndex3]
Files_four_4_g  = Files_merge_g[myRandomIndex4]
Files_five_5_g  = Files_merge_g[myRandomIndex5]

ShortName_one_1_g   = ShortName_merge_g[myRandomIndex1]
ShortName_two_2_g   = ShortName_merge_g[myRandomIndex2]   
ShortName_three_3_g = ShortName_merge_g[myRandomIndex3]
ShortName_four_4_g  = ShortName_merge_g[myRandomIndex4]
ShortName_five_5_g  = ShortName_merge_g[myRandomIndex5]
...
##################################################################################################################
  mySampleID_temp17  <- c( SampleID_two_2_g,   SampleID_three_3_g,   SampleID_four_4_g,   SampleID_five_5_g )
  myTreatment_temp17 <- c( Treatment_two_2_g,  Treatment_three_3_g,  Treatment_four_4_g,  Treatment_five_5_g )
  Sex_temp17         <- c( Sex_two_2_g,        Sex_three_3_g,        Sex_four_4_g,        Sex_five_5_g )
  Tech_temp17        <- c( Type_two_2_g,       Type_three_3_g,       Type_four_4_g,       Type_five_5_g  )
  Files_temp17       <- c( Files_two_2_g,      Files_three_3_g,      Files_four_4_g,      Files_five_5_g  )
  
  for(i in c(1:length(mySampleID_temp17)) ) {
    myTreatment_temp17[i] = 9
  }
  
dataFrame_temp17_A <- data.frame(
  mysampleID  = c(SampleID_one_1_g,   mySampleID_temp17),
  mytreatment = c(Treatment_one_1_g,  myTreatment_temp17),
  mysex       = c(Sex_one_1_g,        Sex_temp17),
  mytech      = c(Type_one_1_g,       Tech_temp17), 
  myfiles     = c(Files_one_1_g,      Files_temp17)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/19A_",  Label_one_1_g, "_vs_", "Others",  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp17_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/19B_",  Label_one_1_g, "_vs_", "Others",  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp17_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/19C_",  Label_one_1_g, "_vs_", "Others",   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp17_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/19D_",  Label_one_1_g, "_vs_", "Others",  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp17_A  )  
##################################################################################################################
...
myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/6A_",  Label_one_1_g, "_vs_", Label_five_5_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp4_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/6B_",  Label_one_1_g, "_vs_", Label_five_5_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp4_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/6C_",  Label_one_1_g, "_vs_", Label_five_5_g,  " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp4_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/6D_",  Label_one_1_g, "_vs_", Label_five_5_g,  " _speRegions",  sep="") ,  
...
myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/7A_",  Label_two_2_g, "_vs_", Label_three_3_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp5_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/7B_",  Label_two_2_g, "_vs_", Label_three_3_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp5_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/7C_",  Label_two_2_g, "_vs_", Label_three_3_g,  " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp5_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/7D_",  Label_two_2_g, "_vs_", Label_three_3_g,  " _speRegions",  sep="") ,  
...
myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/8A_",  Label_two_2_g, "_vs_", Label_four_4_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp6_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/8B_",  Label_two_2_g, "_vs_", Label_four_4_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp6_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/8C_",  Label_two_2_g, "_vs_", Label_four_4_g,  " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp6_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/8D_",  Label_two_2_g, "_vs_", Label_four_4_g,  " _speRegions",  sep="") ,  
...
myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/9A_",  Label_two_2_g, "_vs_", Label_five_5_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp7_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/9B_",  Label_two_2_g, "_vs_", Label_five_5_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp7_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/9C_",  Label_two_2_g, "_vs_", Label_five_5_g,  " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp7_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/9D_",  Label_two_2_g, "_vs_", Label_five_5_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp7_A  )  
##################################################################################################################
...
myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/10A_",  Label_three_3_g, "_vs_", Label_four_4_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp8_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/10B_",  Label_three_3_g, "_vs_", Label_four_4_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp8_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/10C_",  Label_three_3_g, "_vs_", Label_four_4_g,  " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp8_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/10D_",  Label_three_3_g, "_vs_", Label_four_4_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp8_A  )  
##################################################################################################################
...
myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/11A_",  Label_three_3_g, "_vs_", Label_five_5_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp9_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/11B_",  Label_three_3_g, "_vs_", Label_five_5_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp9_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/11C_",  Label_three_3_g, "_vs_", Label_five_5_g,  " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp9_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/11D_",  Label_three_3_g, "_vs_", Label_five_5_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp9_A  )  
##################################################################################################################
...
myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/12A_",  Label_four_4_g, "_vs_", Label_five_5_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp10_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/12B_",  Label_four_4_g, "_vs_", Label_five_5_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp10_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/12C_",  Label_four_4_g, "_vs_", Label_five_5_g,  " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp10_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/12D_",  Label_four_4_g, "_vs_", Label_five_5_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp10_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp11  <- c(  SampleID_two_2_g,   SampleID_three_3_g )
  myTreatment_temp11 <- c(  Treatment_two_2_g,  Treatment_three_3_g )
  Sex_temp11         <- c(  Sex_two_2_g,        Sex_three_3_g )
  Tech_temp11        <- c(  Type_two_2_g,       Type_three_3_g  )
  Files_temp11       <- c(  Files_two_2_g,      Files_three_3_g  )
  
  for(i in c(1:length(mySampleID_temp11)) ) {
    myTreatment_temp11[i] = 9
  }
  
dataFrame_temp11_A <- data.frame(
  mysampleID  = c(SampleID_one_1_g,   mySampleID_temp11),
  mytreatment = c(Treatment_one_1_g,  myTreatment_temp11),
  mysex       = c(Sex_one_1_g,        Sex_temp11),
  mytech      = c(Type_one_1_g,       Tech_temp11), 
  myfiles     = c(Files_one_1_g,      Files_temp11)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/13A_",  Label_one_1_g, "_vs_", Label_two_2_g, "_and_",  Label_three_3_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp11_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/13B_",  Label_one_1_g, "_vs_", Label_two_2_g,  "_and_",  Label_three_3_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp11_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/13C_",  Label_one_1_g, "_vs_", Label_two_2_g, "_and_",  Label_three_3_g,   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp11_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/13D_",  Label_one_1_g, "_vs_", Label_two_2_g,  "_and_",  Label_three_3_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp11_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp12  <- c(  SampleID_two_2_g,   SampleID_four_4_g )
  myTreatment_temp12 <- c(  Treatment_two_2_g,  Treatment_four_4_g )
  Sex_temp12         <- c(  Sex_two_2_g,        Sex_four_4_g )
  Tech_temp12        <- c(  Type_two_2_g,       Type_four_4_g  )
  Files_temp12       <- c(  Files_two_2_g,      Files_four_4_g  )
  
  for(i in c(1:length(mySampleID_temp12)) ) {
    myTreatment_temp12[i] = 9
  }
  
dataFrame_temp12_A <- data.frame(
  mysampleID  = c(SampleID_one_1_g,   mySampleID_temp12),
  mytreatment = c(Treatment_one_1_g,  myTreatment_temp12),
  mysex       = c(Sex_one_1_g,        Sex_temp12),
  mytech      = c(Type_one_1_g,       Tech_temp12), 
  myfiles     = c(Files_one_1_g,      Files_temp12)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/14A_",  Label_one_1_g, "_vs_", Label_two_2_g, "_and_",  Label_four_4_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp12_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/14B_",  Label_one_1_g, "_vs_", Label_two_2_g,  "_and_",  Label_four_4_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp12_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/14C_",  Label_one_1_g, "_vs_", Label_two_2_g, "_and_",  Label_four_4_g,   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp12_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/14D_",  Label_one_1_g, "_vs_", Label_two_2_g,  "_and_",  Label_four_4_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp12_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp13  <- c(  SampleID_two_2_g,   SampleID_five_5_g )
  myTreatment_temp13 <- c(  Treatment_two_2_g,  Treatment_five_5_g )
  Sex_temp13         <- c(  Sex_two_2_g,        Sex_five_5_g )
  Tech_temp13        <- c(  Type_two_2_g,       Type_five_5_g  )
  Files_temp13       <- c(  Files_two_2_g,      Files_five_5_g  )
  
  for(i in c(1:length(mySampleID_temp13)) ) {
    myTreatment_temp13[i] = 9
  }
  
dataFrame_temp13_A <- data.frame(
  mysampleID  = c(SampleID_one_1_g,   mySampleID_temp13),
  mytreatment = c(Treatment_one_1_g,  myTreatment_temp13),
  mysex       = c(Sex_one_1_g,        Sex_temp13),
  mytech      = c(Type_one_1_g,       Tech_temp13), 
  myfiles     = c(Files_one_1_g,      Files_temp13)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/15A_",  Label_one_1_g, "_vs_", Label_two_2_g, "_and_",  Label_five_5_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp13_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/15B_",  Label_one_1_g, "_vs_", Label_two_2_g,  "_and_",  Label_five_5_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp13_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/15C_",  Label_one_1_g, "_vs_", Label_two_2_g, "_and_",  Label_five_5_g,   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp13_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/15D_",  Label_one_1_g, "_vs_", Label_two_2_g,  "_and_",  Label_five_5_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp13_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp14  <- c(  SampleID_three_3_g,   SampleID_four_4_g )
  myTreatment_temp14 <- c(  Treatment_three_3_g,  Treatment_four_4_g )
  Sex_temp14         <- c(  Sex_three_3_g,        Sex_four_4_g )
  Tech_temp14        <- c(  Type_three_3_g,       Type_four_4_g  )
  Files_temp14       <- c(  Files_three_3_g,      Files_four_4_g  )
  
  for(i in c(1:length(mySampleID_temp14)) ) {
    myTreatment_temp14[i] = 9
  }
  
dataFrame_temp14_A <- data.frame(
  mysampleID  = c(SampleID_one_1_g,   mySampleID_temp14),
  mytreatment = c(Treatment_one_1_g,  myTreatment_temp14),
  mysex       = c(Sex_one_1_g,        Sex_temp14),
  mytech      = c(Type_one_1_g,       Tech_temp14), 
  myfiles     = c(Files_one_1_g,      Files_temp14)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/16A_",  Label_one_1_g, "_vs_", Label_three_3_g, "_and_",  Label_four_4_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp14_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/16B_",  Label_one_1_g, "_vs_", Label_three_3_g,  "_and_",  Label_four_4_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp14_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/16C_",  Label_one_1_g, "_vs_", Label_three_3_g, "_and_",  Label_four_4_g,   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp14_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/16D_",  Label_one_1_g, "_vs_", Label_three_3_g,  "_and_",  Label_four_4_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp14_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp15  <- c(  SampleID_three_3_g,   SampleID_five_5_g )
  myTreatment_temp15 <- c(  Treatment_three_3_g,  Treatment_five_5_g )
  Sex_temp15         <- c(  Sex_three_3_g,        Sex_five_5_g )
  Tech_temp15        <- c(  Type_three_3_g,       Type_five_5_g  )
  Files_temp15       <- c(  Files_three_3_g,      Files_five_5_g  )
  
  for(i in c(1:length(mySampleID_temp15)) ) {
    myTreatment_temp15[i] = 9
  }
  
dataFrame_temp15_A <- data.frame(
  mysampleID  = c(SampleID_one_1_g,   mySampleID_temp15),
  mytreatment = c(Treatment_one_1_g,  myTreatment_temp15),
  mysex       = c(Sex_one_1_g,        Sex_temp15),
  mytech      = c(Type_one_1_g,       Tech_temp15), 
  myfiles     = c(Files_one_1_g,      Files_temp15)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/17A_",  Label_one_1_g, "_vs_", Label_three_3_g, "_and_",  Label_five_5_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp15_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/17B_",  Label_one_1_g, "_vs_", Label_three_3_g,  "_and_",  Label_five_5_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp15_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/17C_",  Label_one_1_g, "_vs_", Label_three_3_g, "_and_",  Label_five_5_g,   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp15_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/17D_",  Label_one_1_g, "_vs_", Label_three_3_g,  "_and_",  Label_five_5_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp15_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp16  <- c(  SampleID_four_4_g,   SampleID_five_5_g )
  myTreatment_temp16 <- c(  Treatment_four_4_g,  Treatment_five_5_g )
  Sex_temp16         <- c(  Sex_four_4_g,        Sex_five_5_g )
  Tech_temp16        <- c(  Type_four_4_g,       Type_five_5_g  )
  Files_temp16       <- c(  Files_four_4_g,      Files_five_5_g  )
  
  for(i in c(1:length(mySampleID_temp16)) ) {
    myTreatment_temp16[i] = 9
  }
  
dataFrame_temp16_A <- data.frame(
  mysampleID  = c(SampleID_one_1_g,   mySampleID_temp16),
  mytreatment = c(Treatment_one_1_g,  myTreatment_temp16),
  mysex       = c(Sex_one_1_g,        Sex_temp16),
  mytech      = c(Type_one_1_g,       Tech_temp16), 
  myfiles     = c(Files_one_1_g,      Files_temp16)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/18A_",  Label_one_1_g, "_vs_", Label_four_4_g, "_and_",  Label_five_5_g,  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp16_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/18B_",  Label_one_1_g, "_vs_", Label_four_4_g,  "_and_",  Label_five_5_g,  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp16_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/18C_",  Label_one_1_g, "_vs_", Label_four_4_g, "_and_",  Label_five_5_g,   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp16_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/18D_",  Label_one_1_g, "_vs_", Label_four_4_g,  "_and_",  Label_five_5_g,  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp16_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp18A  <- c( SampleID_two_2_g,   SampleID_three_3_g  )
  myTreatment_temp18A <- c( Treatment_two_2_g,  Treatment_three_3_g  )
  Sex_temp18A         <- c( Sex_two_2_g,        Sex_three_3_g  )
  Tech_temp18A        <- c( Type_two_2_g,       Type_three_3_g   )
  Files_temp18A       <- c( Files_two_2_g,      Files_three_3_g   )

  mySampleID_temp18B  <- c( SampleID_four_4_g,   SampleID_five_5_g )
  myTreatment_temp18B <- c( Treatment_four_4_g,  Treatment_five_5_g )
  Sex_temp18B         <- c( Sex_four_4_g,        Sex_five_5_g )
  Tech_temp18B        <- c( Type_four_4_g,       Type_five_5_g  )
  Files_temp18B       <- c( Files_four_4_g,      Files_five_5_g  )
 
  for(i in c(1:length(mySampleID_temp18A)) ) {
    myTreatment_temp18A[i] = 0
  }
 
  for(i in c(1:length(mySampleID_temp18B)) ) {
    myTreatment_temp18B[i] = 9
  }
   
dataFrame_temp18_A <- data.frame(
  mysampleID  = c(mySampleID_temp18A,   mySampleID_temp18B),
  mytreatment = c(myTreatment_temp18A,  myTreatment_temp18B),
  mysex       = c(Sex_temp18A,        Sex_temp18B),
  mytech      = c(Tech_temp18A,       Tech_temp18B), 
  myfiles     = c(Files_temp18A,      Files_temp18B)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/20A_",  "2-3", "_vs_", "4-5",  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp18_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/20B_",  "2-3", "_vs_", "4-5",  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp18_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/20C_",  "2-3", "_vs_", "4-5",   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp18_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/20D_",  "2-3", "_vs_", "4-5",  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp18_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp19A  <- c( SampleID_two_2_g,   SampleID_four_4_g )
  myTreatment_temp19A <- c( Treatment_two_2_g,  Treatment_four_4_g )
  Sex_temp19A         <- c( Sex_two_2_g,        Sex_four_4_g )
  Tech_temp19A        <- c( Type_two_2_g,       Type_four_4_g )
  Files_temp19A       <- c( Files_two_2_g,      Files_four_4_g )

  mySampleID_temp19B  <- c( SampleID_three_3_g,   SampleID_five_5_g  )
  myTreatment_temp19B <- c( Treatment_three_3_g,  Treatment_five_5_g )
  Sex_temp19B         <- c( Sex_three_3_g,        Sex_five_5_g    )
  Tech_temp19B        <- c( Type_three_3_g,       Type_five_5_g   )
  Files_temp19B       <- c( Files_three_3_g,      Files_five_5_g  )
 
  for(i in c(1:length(mySampleID_temp19A)) ) {
    myTreatment_temp19A[i] = 0
  }
 
  for(i in c(1:length(mySampleID_temp19B)) ) {
    myTreatment_temp19B[i] = 9
  }
   
dataFrame_temp19_A <- data.frame(
  mysampleID  = c(mySampleID_temp19A,   mySampleID_temp19B),
  mytreatment = c(myTreatment_temp19A,  myTreatment_temp19B),
  mysex       = c(Sex_temp19A,        Sex_temp19B),
  mytech      = c(Tech_temp19A,       Tech_temp19B), 
  myfiles     = c(Files_temp19A,      Files_temp19B)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/21A_",  "2-4", "_vs_", "3-5",  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp19_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/21B_",  "2-4", "_vs_", "3-5",  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp19_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/21C_",  "2-4", "_vs_", "3-5",   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp19_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/21D_",  "2-4", "_vs_", "3-5",  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp19_A  )  
##################################################################################################################
...
##################################################################################################################
  mySampleID_temp20A  <- c( SampleID_two_2_g,   SampleID_five_5_g )
  myTreatment_temp20A <- c( Treatment_two_2_g,  Treatment_five_5_g )
  Sex_temp20A         <- c( Sex_two_2_g,        Sex_five_5_g )
  Tech_temp20A        <- c( Type_two_2_g,       Type_five_5_g  )
  Files_temp20A       <- c( Files_two_2_g,      Files_five_5_g  )

  mySampleID_temp20B  <- c( SampleID_three_3_g,   SampleID_four_4_g )
  myTreatment_temp20B <- c( Treatment_three_3_g,  Treatment_four_4_g )
  Sex_temp20B         <- c( Sex_three_3_g,        Sex_four_4_g )
  Tech_temp20B        <- c( Type_three_3_g,       Type_four_4_g  )
  Files_temp20B       <- c( Files_three_3_g,      Files_four_4_g  )
 
  for(i in c(1:length(mySampleID_temp20A)) ) {
    myTreatment_temp20A[i] = 0
  }
 
  for(i in c(1:length(mySampleID_temp20B)) ) {
    myTreatment_temp20B[i] = 9
  }
   
dataFrame_temp20_A <- data.frame(
  mysampleID  = c(mySampleID_temp20A,   mySampleID_temp20B),
  mytreatment = c(myTreatment_temp20A,  myTreatment_temp20B),
  mysex       = c(Sex_temp20A,        Sex_temp20B),
  mytech      = c(Tech_temp20A,       Tech_temp20B), 
  myfiles     = c(Files_temp20A,      Files_temp20B)
)

myMainFunction1bp_1_g(  myobj_temp1     = my_methylBase_object,   
                        path_temp1      = paste(outDir_g, "/22A_",  "2-5", "_vs_", "3-4",  " _1bp",  sep="") ,      
                        dataFrame_temp1 = dataFrame_temp20_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/22B_",  "2-5", "_vs_", "3-4",  " _50bp",  sep="")  ,   
                     binSize_temp1 = 50,   binBases_temp1 = 1,   dataFrame_temp1 = dataFrame_temp20_A  )

myMainFunction_1_g(  myobj_temp1 = my_methylBase_object,     
                     path_temp1 = paste(outDir_g, "/22C_",  "2-5", "_vs_", "3-4",   " _100bp",  sep="")  ,   
                     binSize_temp1 = 100,   binBases_temp1 = 3,   dataFrame_temp1 = dataFrame_temp20_A  )

myMainFunction_speRegions_All_g(myobj_temp2 = my_methylBase_object,   
                                path_temp2 = paste(outDir_g, "/22D_",  "2-5", "_vs_", "3-4",  " _speRegions",  sep="") ,  
                                binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp20_A  )  
##################################################################################################################
