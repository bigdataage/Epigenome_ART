...
## Example:  
## Rscript  3100_twins_fathers.R     12_Twins/A-rmXY     3100_twins_fathers/A-rmXY    >     3100_twins_fathers_A-rmXY.runLog  2>&1     
...
#   outDir_g   =  "3100_twins_fathers_test/C-onlyX"
...
Files_one_1_g   = list.files( path = paste(inputDir_g, "/", "Parents_NC/ALL", sep="") ,                pattern = "-father-" ,    full.names = TRUE )
Files_two_2_g   = list.files( path = paste(inputDir_g, "/", "Parents_Fresh/IVF-fresh", sep="") ,       pattern = "-father-" ,    full.names = TRUE )
Files_three_3_g = list.files( path = paste(inputDir_g, "/", "Parents_Fresh/ICSI-fresh", sep="") ,      pattern = "-father-" ,    full.names = TRUE )
Files_four_4_g  = list.files( path = paste(inputDir_g, "/", "Parents_Frozen/IVF-frozen", sep="") ,     pattern = "-father-" ,    full.names = TRUE )
Files_five_5_g  = list.files( path = paste(inputDir_g, "/", "Parents_Frozen/ICSI-frozen", sep="") ,    pattern = "-father-" ,    full.names = TRUE )

ShortName_one_1_g   = list.files( path = paste(inputDir_g, "/", "Parents_NC/ALL", sep="") ,               pattern = "-father-" ,    full.names = FALSE )
ShortName_two_2_g   = list.files( path = paste(inputDir_g, "/", "Parents_Fresh/IVF-fresh", sep="") ,      pattern = "-father-" ,    full.names = FALSE )
ShortName_three_3_g = list.files( path = paste(inputDir_g, "/", "Parents_Fresh/ICSI-fresh", sep="") ,     pattern = "-father-" ,    full.names = FALSE )
ShortName_four_4_g  = list.files( path = paste(inputDir_g, "/", "Parents_Frozen/IVF-frozen", sep="") ,    pattern = "-father-" ,    full.names = FALSE )
ShortName_five_5_g  = list.files( path = paste(inputDir_g, "/", "Parents_Frozen/ICSI-frozen", sep="") ,   pattern = "-father-" ,    full.names = FALSE )
