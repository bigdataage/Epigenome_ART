...
## Example:  
## Rscript  1100_TwinsPups_IVF-Fresh-vs-Frozen.R     12_Twins/A-rmXY     1100_TwinsPups_IVF-Fresh-vs-Frozen/A-rmXY    >     1100_TwinsPups_IVF-Fresh-vs-Frozen_A-rmXY.runLog  2>&1     
...
#   outDir_g   =  "1100_TwinsPups_IVF-Fresh-vs-Frozen_test/C-onlyX"
...
Files_one_1_g   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/IVF-fresh_1", sep="") ,      pattern = "" ,    full.names = TRUE )
Files_two_2_g   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/IVF-fresh_2", sep="") ,      pattern = "" ,    full.names = TRUE )
Files_three_3_g = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_1", sep="") ,    pattern = "" ,    full.names = TRUE )
Files_four_4_g  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_2", sep="") ,    pattern = "" ,    full.names = TRUE )
# Files_five_5_g  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_2", sep="") ,    pattern = "" ,    full.names = TRUE )

ShortName_one_1_g   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/IVF-fresh_1", sep="") ,      pattern = "" ,    full.names = FALSE )
ShortName_two_2_g   = list.files( path = paste(inputDir_g, "/", "Pups_Fresh/IVF-fresh_2", sep="") ,      pattern = "" ,    full.names = FALSE )
ShortName_three_3_g = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_1", sep="") ,    pattern = "" ,    full.names = FALSE )
ShortName_four_4_g  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_2", sep="") ,    pattern = "" ,    full.names = FALSE )
# Files_five_5_g  = list.files( path = paste(inputDir_g, "/", "Pups_Frozen/IVF-frozen_2", sep="") ,    pattern = "" ,    full.names = FALSE )
