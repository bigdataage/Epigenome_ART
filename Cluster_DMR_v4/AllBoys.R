...
myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/11_ICSI_fresh_vs_ICSI_frozen_speRegions",  sep="") ,  
...
myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/6_IVF_fresh_vs_IVF_frozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/1_NC-vs-ART_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/2_NC-vs-IVFfresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/17_IVF_vs_ICSI_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/3_NC-vs-IVFfrozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/4_NC-vs-ICSIfresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/5_NC-vs-ICSIfrozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/7_IVF_fresh_vs_ICSI_fresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/8_IVF_fresh_vs_ICSI_frozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/9_IVF_frozen_vs_ICSI_fresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/10_IVF_frozen_vs_ICSI_frozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/12_NC_vs_IVF_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/13_NC_vs_ICSI_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/14_NC_vs_fresh_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/15_NC_vs_frozen_speRegions",  sep="") ,  
...
##################################################################################################################
  ...
  myMainFunction_speRegions_All_g(myobj_temp2 = myobj_nor_g,   path_temp2paste(outDir_g, "/18_fresh_vs_frozen_speRegions",  sep="") ,  
