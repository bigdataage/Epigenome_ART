...
## Example:  
##          Rscript  AllPups.R     1-covFiles/A-rmXY     3-AllPups/A-rmXY   >     3-AllPups_A-rmXY.runLog  2>&1     
...
#   inputDir_g =  "1-covFiles/A-rmXY"
#   outDir_g   =  "3-AllPups/A-rmXY"
print(inputDir_g)   
print(outDir_g)
...
Sex_NC_g = c()
Files_NC_g <- c(
  paste( inputDir_g,   "75_E98-NC-D_Rep3.bismark.cov",            sep="/" ),
  ...
  paste( inputDir_g,   "27_E16C-boy-NC-merge_Rep1.bismark.cov",   sep="/" ),
  paste( inputDir_g,   "chenwei_101_E114C-boy-NC_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei_102_E54D-boy-NC_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei2_252_A87C-boy-NC_Rep1.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei2_253_A91C-boy-NC_Rep1.bismark.cov",  sep="/" ),  #12
  
  paste( inputDir_g,   "75_E98-NC-C_Rep3.bismark.cov",            sep="/"),
  paste( inputDir_g,   "63_NC-E8-D-Girl_Rep2.bismark.cov",        sep="/"),
  paste( inputDir_g,   "40_E12C-girl-NC_Rep1.bismark.cov",        sep="/"),
  paste( inputDir_g,   "41_E13C-girl-NC_Rep1.bismark.cov",        sep="/"), 
  paste( inputDir_g,   "chenwei_101_E114D-girl-NC_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei_102_E54C-girl-NC_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei_1_BS2C-girl-NC_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei_1_BS2D-girl-NC_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei_3_E8C-girl-NC_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei2_203_A92C-girl-NC_Rep1.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei2_4_E103C-girl-NC_Rep1.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei2_4_E103D-girl-NC_Rep1.bismark.cov",  sep="/" )  
)
 
if( length(Files_NC_g) >= 1) {
...
Files_IVF_fresh_g = c()
Tech_IVF_fresh_g  = c()
mySampleID_IVF_fresh_g  = c()
myTreatment_IVF_fresh_g = c()
Sex_IVF_fresh_g = c()
Files_IVF_fresh_g <- c(   
  ...
  paste( inputDir_g,   "chenwei_111_E18D-boy-IVFfresh_Rep9.CpG.bismark.cov",  sep="/" ),
  paste( inputDir_g,   "chenwei_113_E101D-boy-IVFfresh_Rep9.CpG.bismark.cov",  sep="/" ),  #13
  ...
  paste( inputDir_g,   "chenwei_11_BS18C-girl-IVFfresh_Rep9.CpG.bismark.cov",  sep="/" ),
...
if( length(Files_IVF_fresh_g) >= 1) {
    ...
    for(i in c(1:length(Sex_IVF_fresh_g)) ) {
        ...
        if(i>=14) { Sex_IVF_fresh_g[i] = "girl" }
    }
}
...
Tech_IVF_frozen_g  = c()
mySampleID_IVF_frozen_g  = c()
myTreatment_IVF_frozen_g = c()
Sex_IVF_frozen_g = c()
Files_IVF_frozen_g <- c(  
  ...
  paste( inputDir_g,   "33_W104C-boy-IVF-frozen_Rep1.bismark.cov",     sep="/" ),  #12
  ...
  paste( inputDir_g,     "chenwei2_274_E35C-girl-IVF-frozen_Rep1.bismark.cov",  sep="/" )
)
 
if( length(Files_IVF_frozen_g) >= 1) {
...
Tech_ICSI_fresh_g  = c()
mySampleID_ICSI_fresh_g  = c()
myTreatment_ICSI_fresh_g = c()
Sex_ICSI_fresh_g = c()
Files_ICSI_fresh_g <- c(
  ...
  paste( inputDir_g,   "36_W928C-boy-ICSI-fresh-merge_Rep1.bismark.cov",   sep="/" ), #12
...
if( length(Files_ICSI_fresh_g) >= 1) {
...
Tech_ICSI_frozen_g  = c()
mySampleID_ICSI_frozen_g  = c()
myTreatment_ICSI_frozen_g = c()
Sex_ICSI_frozen_g = c()
Files_ICSI_frozen_g <- c(
  paste( inputDir_g,    "23_E45D-boy-ICSI-frozen_Rep1.bismark.cov",        sep="/"),
  paste( inputDir_g,    "24_W774C-ICSI-frozen_Rep1.bismark.cov",           sep="/"),
  paste( inputDir_g,    "25_E115C-boy-ICSI-frozen_Rep1.bismark.cov" ,      sep="/"),
  paste( inputDir_g,    "26_A19C-ICSI-frozen_Rep1.bismark.cov",            sep="/"),
  ...
  paste( inputDir_g,    "37_W618C-boy-ICSI-frozen_Rep1.bismark.cov",       sep="/"),
  paste( inputDir_g,    "38_W1531C-boy-ICSI-frozen_Rep1.bismark.cov",      sep="/"), 
  paste( inputDir_g,    "39_W1656-ICSI-frozen-C_Rep1.bismark.cov",         sep="/"),
  paste( inputDir_g,    "chenwei2_145_A28C-X-ICSI-frozen_Rep1.bismark.cov",  sep="/" ),
  paste( inputDir_g,    "chenwei2_92_A62C-boy-ICSI-frozen_Rep1.bismark.cov",  sep="/" ),
  paste( inputDir_g,    "chenwei2_92_A62D-boy-ICSI-frozen_Rep1.bismark.cov",  sep="/" ),  #12

  paste( inputDir_g,    "23_E45C-girl-ICSI-frozen_Rep1.bismark.cov",   sep="/"),
  paste( inputDir_g,    "24_W774D-ICSI-frozen_Rep1.bismark.cov",       sep="/"), 
  paste( inputDir_g,    "25_E115D-ICSI-frozen_Rep1.bismark.cov" ,      sep="/"), 
  paste( inputDir_g,    "26_A19D-ICSI-frozen_Rep1.bismark.cov" ,       sep="/"),
  paste( inputDir_g,    "8_W845C-girl-ICSI-frozen_Rep1.bismark.cov" ,  sep="/"),   
  paste( inputDir_g,    "8_W845D-girl-ICSI-frozen_Rep1.bismark.cov" ,  sep="/"),
  paste( inputDir_g,    "51_W1699C-girl-ICSI-frozen_Rep1.bismark.cov", sep="/"), 
  paste( inputDir_g,    "52_W39-ICSI-frozen-C_Rep1.bismark.cov",       sep="/"), 
  paste( inputDir_g,    "chenwei2_43_A59C-girl-ICSI-frozen_Rep1.bismark.cov",  sep="/" ),
  paste( inputDir_g,    "43_A59C-girl-ICSI-frozen_Rep2.bismark.cov",  sep="/" )   
)
 
if( length(Files_ICSI_frozen_g) >= 1) {
    ...
    for(i in c(1:length(Sex_ICSI_frozen_g)) ) {
      ...
      if(i>=13) { Sex_ICSI_frozen_g[i] = "girl" }
    }
}
...
Files_All_vector_g
mySampleID_All_vector_g
myTreatment_All_vector_g
mySex_All_vector_g
myTech_All_vector_g
...
MyTech_number_g <- function(  myTech_vector  ) {
  myTech_color  = myTech_vector
  for(i in c(1:length(myTech_color)) ) {
    if(myTech_color[i] == "NC")          { myTech_color[i] = 1 }
    ...
    if(myTech_color[i] == "ICSI_frozen") { myTech_color[i] = 5 }
  }
  return(myTech_color)
}
...
myMainFunction_1_g  <- function(  myobj_temp1,   path_temp1,   binSize_temp1, binBases_temp1, dataFrame_temp1  ) {
  ...
  tryCatch(
      MyCluster_3_g(  mymeth2=meth_2two ,  path2=path_temp1_sub2,     file2="HierarchicalClustering_byMethylKit_",   width2=35,   height2=15 ),
      error = function(err){"000"}
  )
  ...
  #tryCatch(
  #    MyPCA_3_g(  mymeth2=meth_2two ,  path2=path_temp1_sub3,     file2="PCA_byMethylKit_",   width2=11,   height2=9 ),
  #    error = function(err){"000"}
  #)
  ...
  tryCatch(
        myHierarchicalClustering_1_g(  mat_3three=mat_2two,   path_temp1=path_temp1_sub7,   width1=35, height1=15  ) ,
        error = function(err){"000"}
  )
...
myMainFunction1bp_1_g  <- function(  myobj_temp1,   path_temp1,   dataFrame_temp1  ) {
  ...
  path_temp1_sub3 = paste(path_temp1, "3_PCA_byMethylKit", sep="/")
  if( ! file.exists(path_temp1_sub3) ) { dir.create(path_temp1_sub3, recursive = TRUE) }
  #MyPCA_3_g(  mymeth2=meth_2two ,  path2=path_temp1_sub3,     file2="PCA_byMethylKit_",   width2=5,   height2=5 )
...
myMainFunction_test_g  <- function(  myobj_temp1,   path_temp1,   binSize_temp1, binBases_temp1, dataFrame_temp1  ) {
  if( ! file.exists(path_temp1) ) { dir.create(path_temp1, recursive = TRUE) }
...
myMainFunction1bp_test_g  <- function(  myobj_temp1,   path_temp1,   dataFrame_temp1  ) {
  if( ! file.exists(path_temp1) ) { dir.create(path_temp1, recursive = TRUE) }
...
myMainFunction_speRegions_g  <- function(  myobj_temp1,   path_temp1,  speRegions_temp1,   binBases_temp1,  dataFrame_temp1  ) {
  ## speRegions_temp1 = gene.obj_g$promoters
  if( ! file.exists(path_temp1) ) { dir.create(path_temp1, recursive = TRUE) }
  ...
  myobj_2two = regionCounts(myobj_2two,  speRegions_temp1,   cov.bases=binBases_temp1,  strand.aware=FALSE)  
  meth_2two  = unite( myobj_2two, destrand=FALSE, mc.cores=16   )   ## 100% overlap
  mat_2two   = percMethylation( meth_2two )
  ...
  if( ! file.exists(path_temp1_sub9) ) { dir.create(path_temp1_sub9, recursive = TRUE) }
  myDiff_overdispersion_Ftest_g(  methobj2=meth_2two,   path2=path_temp1_sub9  )
  ##  If overdispersion correction is applied, the function automatically switches to the F-test. 
...
myMainFunction_speRegions_All_g  <- function(  myobj_temp2,   path_temp2,  binBases_temp2,  dataFrame_temp2  )  {
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/1_promoters_1kb",  sep="") , 
                                speRegions_temp1= gene.obj_g$promoters,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/2_promoters_500bp",  sep="") , 
                                speRegions_temp1= gene.obj_500bp_g$promoters,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ) , 
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/3_promoters_total_3kb",  sep="") , 
                                speRegions_temp1= gene.obj_total_3kb_g$promoters,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ), 
  error = function(err){"000"}
  )
  
  #myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/4_exons",  sep="") , 
  #                              speRegions_temp1= gene.obj_g$exons ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  )
  
  #myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/5_introns",  sep="") , 
  #                              speRegions_temp1= gene.obj_g$introns ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-1A_imprintRegions",  sep="") , 
                                speRegions_temp1= imprint1.obj_g$ImprintedRegions ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-1B_imprintRegions-shores",  sep="") , 
                                speRegions_temp1= imprint1.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-2A_imprintRegions",  sep="") , 
                                speRegions_temp1= imprint2.obj_g$ImprintedRegions ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-2B_imprintRegions-shores",  sep="") , 
                                speRegions_temp1= imprint2.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-3A_imprintRegions",  sep="") , 
                                speRegions_temp1= imprint3.obj_g$ImprintedRegions ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-3B_imprintRegions-shores",  sep="") , 
                                speRegions_temp1= imprint3.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-4A_imprintRegions",  sep="") , 
                                speRegions_temp1= imprint4.obj_g$ImprintedRegions ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-4B_imprintRegions-shores",  sep="") , 
                                speRegions_temp1= imprint4.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-5A_imprintRegions",  sep="") , 
                                speRegions_temp1= imprint5.obj_g$ImprintedRegions ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/6-5B_imprintRegions-shores",  sep="") , 
                                speRegions_temp1= imprint5.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/7-A_H3K4me1Peaks",  sep="") , 
                                speRegions_temp1= region_1_H3K4me1.obj_g$H3K4me1 ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/7-B_H3K4me1-shores",  sep="") , 
                                speRegions_temp1= region_1_H3K4me1.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/8-A_H3K4me3Peaks",  sep="") , 
                                speRegions_temp1= region_2_H3K4me3.obj_g$H3K4me3 ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/8-B_H3K4me3-shores",  sep="") , 
                                speRegions_temp1= region_2_H3K4me3.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/9-A_H3K27acPeaks",  sep="") , 
                                speRegions_temp1= region_3_H3K27ac.obj_g$H3K27ac ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/9-B_H3K27ac-shores",  sep="") , 
  ...
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/10-A_H3K27me3Peaks",  sep="") , 
                                speRegions_temp1= region_4_H3K27me3.obj_g$H3K27me3 ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/10-B_H3K27me3-shores",  sep="") , 
                                speRegions_temp1= region_4_H3K27me3.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  
  #myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/11-A_centromeres",  sep="") , 
                                #speRegions_temp1= region_6_centromeres.obj_g$centromere ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  )
  
  #myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/11-B_centromeres-shores",  sep="") , 
                                #speRegions_temp1= region_6_centromeres.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  )
  
  
  tryCatch( 
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/12-A_HouseKeeping",  sep="") , 
                                speRegions_temp1= region_9_HouseKeeping.obj_g$HouseKeeping ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/12-B_HouseKeeping-shores",  sep="") , 
  ...
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/13-A_rRNAGenes",  sep="") , 
                                speRegions_temp1= region_10_rRNA.obj_g$rRNA_Genes ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/13-B_rRNA-shores",  sep="") , 
  ...
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/14-A_activeEnhancers",  sep="") , 
                                speRegions_temp1= region_11A_activeEn.obj_g$activeEnhancers ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/14-B_activeEnhancers-shores",  sep="") , 
  ...
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/15-A_otherEnhancers",  sep="") , 
                                speRegions_temp1= region_11B_otherEn.obj_g$otherEnhancers,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/15-B_otherEnhancers-shores",  sep="") , 
                                speRegions_temp1= region_11B_otherEn.obj_g$shores ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/16-A_posiedEnhancers",  sep="") , 
                                speRegions_temp1= region_11C_posiedEn.obj_g$posiedEnhancers ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/16-B_posiedEnhancers-shores",  sep="") , 
  ...
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/17-A_primedEnhancers",  sep="") , 
                                speRegions_temp1= region_11D_primedEn.obj_g$primedEnhancers ,   binBases_temp1=binBases_temp2,  dataFrame_temp1 = dataFrame_temp2  ),
  error = function(err){"000"}
  )
  
  tryCatch(
  myMainFunction_speRegions_g(  myobj_temp1 = myobj_temp2,   path_temp1 = paste(path_temp2, "/SpeRegions/17-B_primedEnhancers-shores",  sep="") , 
...
gene.obj_g     = readTranscriptFeatures(myRefSeqGenes_g, remove.unusual=TRUE, up.flank=1000, down.flank=1000,  unique.prom=TRUE)
gene.obj_500bp_g     = readTranscriptFeatures(myRefSeqGenes_g, remove.unusual=TRUE, up.flank=500, down.flank=500,  unique.prom=TRUE)
gene.obj_total_3kb_g     = readTranscriptFeatures(myRefSeqGenes_g, remove.unusual=TRUE, up.flank=1000, down.flank=0,  unique.prom=TRUE)
...
filtered.myobj_g = filterByCoverage( myobj_g,  lo.count = lowestCoverage_g,  lo.perc = NULL,  hi.count = NULL,  hi.perc = 99.9,  chunk.size = 1e+06,  save.db = FALSE )        
...
removed.myobj_g = filterByCoverage( myobj_g,  lo.count = lowestCoverage_g,  lo.perc = 99.9,  hi.count = NULL,  hi.perc = NULL,  chunk.size = 1e+06,  save.db = FALSE )
...
##################################################################################################################
  ...
  myMainFunction1bp_test_g(  myobj_temp1 = myobj_nor_g,   
                             path_temp1 = paste(outDir_g, "/TestAllSamples/0_allSamples_1bpBin",  sep="") ,   
                             dataFrame_temp1 = dataFrame_temp1_A   ) 
    
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/1A_allSamples_100bpBin_1Cs",  sep="") ,   
                          binSize_temp1 = 100,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/1B_allSamples_100bpBin_2Cs",  sep="") ,   
                          binSize_temp1 = 100,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/1C_allSamples_100bpBin_3Cs",  sep="") ,   
                          binSize_temp1 = 100,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp1_A  )
  
  
  
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/1X_allSamples_50bpBin_1Cs",  sep="") ,   
                          binSize_temp1 = 50,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/1Y_allSamples_50bpBin_2Cs",  sep="") ,   
                          binSize_temp1 = 50,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/1Z_allSamples_50bpBin_3Cs",  sep="") ,   
                          binSize_temp1 = 50,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp1_A  )
  
  
  
  
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/2A_allSamples_200bpBin_1Cs",  sep="") ,   
                          binSize_temp1 = 200,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/2B_allSamples_200bpBin_3Cs",  sep="") ,   
                          binSize_temp1 = 200,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/2C_allSamples_200bpBin_5Cs",  sep="") ,   
                          binSize_temp1 = 200,   binBases_temp1 = 5, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/2D_allSamples_200bpBin_7Cs",  sep="") ,   
                          binSize_temp1 = 200,   binBases_temp1 = 7, dataFrame_temp1 = dataFrame_temp1_A  )
  
  
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/3A_allSamples_300bpBin_1Cs",  sep="") ,   
                          binSize_temp1 = 300,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/3B_allSamples_300bpBin_3Cs",  sep="") ,   
                          binSize_temp1 = 300,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/3C_allSamples_300bpBin_5Cs",  sep="") ,   
                          binSize_temp1 = 300,   binBases_temp1 = 5, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/3D_allSamples_300bpBin_7Cs",  sep="") ,   
                          binSize_temp1 = 300,   binBases_temp1 = 7, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/3E_allSamples_300bpBin_10Cs",  sep="") ,   
                          binSize_temp1 = 300,   binBases_temp1 = 10, dataFrame_temp1 = dataFrame_temp1_A  ) 
  

    
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/4A_allSamples_400bpBin_1Cs",  sep="") ,   
                          binSize_temp1 = 400,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/4B_allSamples_400bpBin_3Cs",  sep="") ,   
                          binSize_temp1 = 400,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/4C_allSamples_400bpBin_7Cs",  sep="") ,   
                          binSize_temp1 = 400,   binBases_temp1 = 7, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/4D_allSamples_400bpBin_10Cs",  sep="") ,   
                          binSize_temp1 = 400,   binBases_temp1 = 10, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/4E_allSamples_400bpBin_12Cs",  sep="") ,   
                          binSize_temp1 = 400,   binBases_temp1 = 12, dataFrame_temp1 = dataFrame_temp1_A  ) 
  
  

  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/5A_allSamples_500bpBin_3Cs",  sep="") ,   
                          binSize_temp1 = 500,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/5B_allSamples_500bpBin_6Cs",  sep="") ,   
                          binSize_temp1 = 500,   binBases_temp1 = 6, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/5C_allSamples_500bpBin_10Cs",  sep="") ,   
                          binSize_temp1 = 500,   binBases_temp1 = 10, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/5D_allSamples_500bpBin_15Cs",  sep="") ,   
                          binSize_temp1 = 500,   binBases_temp1 = 15, dataFrame_temp1 = dataFrame_temp1_A  )
  
  
  
  
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/6A_allSamples_1000bpBin_5Cs",  sep="") ,   
                          binSize_temp1 = 1000,   binBases_temp1 = 5, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/6B_allSamples_1000bpBin_10Cs",  sep="") ,   
                          binSize_temp1 = 1000,   binBases_temp1 = 10, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/6C_allSamples_1000bpBin_20Cs",  sep="") ,   
                          binSize_temp1 = 1000,   binBases_temp1 = 20, dataFrame_temp1 = dataFrame_temp1_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestAllSamples/6D_allSamples_1000bpBin_30Cs",  sep="") ,   
                          binSize_temp1 = 1000,   binBases_temp1 = 30, dataFrame_temp1 = dataFrame_temp1_A  )
  
  
  
  
  
  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   path_temp2 = paste(outDir_g, "/TestAllSamples/SomeSpeRegions_1reads",  sep="") ,  
                                    binBases_temp2=1,  dataFrame_temp2 = dataFrame_temp1_A  )
  
  
  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   path_temp2 = paste(outDir_g, "/TestAllSamples/SomeSpeRegions_2reads",  sep="") ,  
                                    binBases_temp2=2,  dataFrame_temp2 = dataFrame_temp1_A  )
  
  
  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   path_temp2 = paste(outDir_g, "/TestAllSamples/SomeSpeRegions_3reads",  sep="") ,  
                                    binBases_temp2=3,  dataFrame_temp2 = dataFrame_temp1_A  )
  ...
  myBinSize_g = 500
  myMinimumCs_g = 3
  myMinimumCs_speRegions_g = 3
  
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/1_NC-vs-ART",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp1_A  )
  
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/1_NC-vs-ART_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp1_A  )

  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/1_NC-vs-ART/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp1_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestSamples2/1X_allSamples_50bpBin_1Cs",  sep="") ,   
                          binSize_temp1 = 50,   binBases_temp1 = 1, dataFrame_temp1 = dataFrame_temp2_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestSamples2/1Y_allSamples_50bpBin_2Cs",  sep="") ,   
                          binSize_temp1 = 50,   binBases_temp1 = 2, dataFrame_temp1 = dataFrame_temp2_A  )
  ###
  myMainFunction_test_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/TestSamples2/1Z_allSamples_50bpBin_3Cs",  sep="") ,   
                          binSize_temp1 = 50,   binBases_temp1 = 3, dataFrame_temp1 = dataFrame_temp2_A  )
  
  
  
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2_NC-vs-IVFfresh",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp2_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/2_NC-vs-IVFfresh_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp2_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/2_NC-vs-IVFfresh/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp2_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/3_NC-vs-IVFfrozen",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp3_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/3_NC-vs-IVFfrozen_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp3_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/3_NC-vs-IVFfrozen/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp3_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/4_NC-vs-ICSIfresh",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp4_A  )
  
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/4_NC-vs-ICSIfresh_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp4_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/4_NC-vs-ICSIfresh/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp4_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/5_NC-vs-ICSIfrozen",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp5_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/5_NC-vs-ICSIfrozen_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp5_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/5_NC-vs-ICSIfrozen/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp5_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/6_IVF_fresh_vs_IVF_frozen",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp6_A  ) 
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/6_IVF_fresh_vs_IVF_frozen_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp6_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/6_IVF_fresh_vs_IVF_frozen/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp6_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/7_IVF_fresh_vs_ICSI_fresh",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp7_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/7_IVF_fresh_vs_ICSI_fresh_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp7_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/7_IVF_fresh_vs_ICSI_fresh/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp7_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/8_IVF_fresh_vs_ICSI_frozen",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp8_A  ) 
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/8_IVF_fresh_vs_ICSI_frozen_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp8_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/8_IVF_fresh_vs_ICSI_frozen/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp8_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/9_IVF_frozen_vs_ICSI_fresh",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp9_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/9_IVF_frozen_vs_ICSI_fresh_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp9_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/9_IVF_frozen_vs_ICSI_fresh/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp9_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/10_IVF_frozen_vs_ICSI_frozen",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp10_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/10_IVF_frozen_vs_ICSI_frozen_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp10_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/10_IVF_frozen_vs_ICSI_frozen/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp10_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/11_ICSI_fresh_vs_ICSI_frozen",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp11_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/11_ICSI_fresh_vs_ICSI_frozen_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp11_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/11_ICSI_fresh_vs_ICSI_frozen/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp11_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/12_NC_vs_IVF",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp12_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/12_NC_vs_IVF_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp12_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/12_NC_vs_IVF/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp12_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/13_NC_vs_ICSI",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp13_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/13_NC_vs_ICSI_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp13_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/13_NC_vs_ICSI/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp13_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/14_NC_vs_fresh",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp14_A  ) 
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/14_NC_vs_fresh_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp14_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/14_NC_vs_fresh/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp14_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/15_NC_vs_frozen",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp15_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/15_NC_vs_frozen_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp15_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/15_NC_vs_frozen/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp15_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  ###
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/16_NC_vs_ART",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp16_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/16_NC_vs_ART_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp16_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/16_NC_vs_ART/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp16_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/17_IVF_vs_ICSI",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp17_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/17_IVF_vs_ICSI_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp17_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/17_IVF_vs_ICSI/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp17_A  )
##################################################################################################################
...
##################################################################################################################
  ...
  myMainFunction_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/18_fresh_vs_frozen",  sep="") ,   
                       binSize_temp1 = myBinSize_g,   binBases_temp1 = myMinimumCs_g, dataFrame_temp1 = dataFrame_temp18_A  )
    
  myMainFunction1bp_1_g(  myobj_temp1 = myobj_nor_g,   path_temp1 = paste(outDir_g, "/18_fresh_vs_frozen_1bp",  sep="") ,      
                          dataFrame_temp1 = dataFrame_temp18_A  )


  myMainFunction_speRegions_All_g(  myobj_temp2 = myobj_nor_g,   
                                    path_temp2 = paste(outDir_g, "/18_fresh_vs_frozen/SomeSpeRegions",  sep="") ,  
                                    binBases_temp2=myMinimumCs_speRegions_g,  dataFrame_temp2 = dataFrame_temp18_A  )
##################################################################################################################
